    ...
    if investmentAmount is not None:
        ...
        if investmentAmount < 5000:
            return build_validation_result(
                ...
                'Please, provide a valid investmentAmount.',
            )
...
def recommend_portfolio(intent_request):
    ...
    if riskLevel == 'high':
        ...
        return close(
            ...
            'content': """Thank you for your interest. The recommended portfolio for a {} level of risk is 20% bonds (AGG), 80% equities (SPY).""".format(riskLevel)
            }
        )
        ...
        return close(
            ...
            {
            'contentType': 'PlainText',
            'content': """Thank you for your interest. The recommended portfolio for a {} level of risk is 40% bonds (AGG), 60% equities (SPY).""".format(riskLevel)
            }
        )
        ...
        return close(
            ...
            {
            'contentType': 'PlainText',
            'content': """Thank you for your interest. The recommended portfolio for a {} level of risk is 60% bonds (AGG), 40% equities (SPY).""".format(riskLevel)
            }
        )
        ...
        return close(
            ...
            {
            'contentType': 'PlainText',
            'content': """Thank you for your interest; The recommended portfolio for a {} level of risk is 100% bonds (AGG), 0% equities (SPY).""".format(riskLevel)
            }
        )
    """
    else:
        ...
        return build_validation_result(
            False,
            'riskLevel',
            'The risk level you selected is not defined '
            'Please, provide a valid riskLevel.',
        )
    """
